...
std::vector<InfillTestParameters> generateInfillTests()
{
    ...
    std::vector<EFillMethod> skip_methods
        = { EFillMethod::CONCENTRIC, EFillMethod::ZIG_ZAG,        EFillMethod::CROSS,  EFillMethod::CROSS_3D,
            EFillMethod::CUBICSUBDIV, EFillMethod::TRIANGLE_WAVE_SIMPLE, EFillMethod::TRIANGLE_WAVE_ADVANCED, EFillMethod::TRIANGLE_WAVE_EPIC,
            EFillMethod::GYROID, EFillMethod::LIGHTNING };
